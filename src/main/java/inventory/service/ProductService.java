...
public class ProductService {
	...
	public void standardizationCanned(Product product) {
		if(product.getCan().equals("Non") || product.getCan().equals("non") || product.getCan().equals("No") || product.getCan().equals("no") || 
				product.getCan().equals("Nope") || product.getCan().equals("nope")) {
			product.setCan("Non");
		}
		else if(product.getCan().equals("Oui") || product.getCan().equals("oui") || product.getCan().equals("yes") || product.getCan().equals("Yes") || 
				product.getCan().equals("yep") || product.getCan().equals("Yep")) {
			product.setCan("Oui");
		}
